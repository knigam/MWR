...
class DiningsControllerTest < ActionController::TestCase
  ...
  test "should create dining" do
    assert_difference('Dining.count') do
      post :create, dining: { description: @dining.description, location: @dining.location, name: @dining.name, price: @dining.price, url: @dining.url }
    end
  ...
  test "should update dining" do
    patch :update, id: @dining, dining: { description: @dining.description, location: @dining.location, name: @dining.name, price: @dining.price, url: @dining.url }
    assert_redirected_to dining_path(assigns(:dining))
  end
