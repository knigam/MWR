...
class SocialsControllerTest < ActionController::TestCase
  ...
  test "should create social" do
    assert_difference('Social.count') do
      post :create, social: { description: @social.description, location: @social.location, name: @social.name, price: @social.price, url: @social.url }
    end
  ...
  test "should update social" do
    patch :update, id: @social, social: { description: @social.description, location: @social.location, name: @social.name, price: @social.price, url: @social.url }
    assert_redirected_to social_path(assigns(:social))
  end
